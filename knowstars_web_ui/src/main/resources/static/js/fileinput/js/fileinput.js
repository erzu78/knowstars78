...
(function (factory) {
        ...
        _readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                if ($preview.length && FileReader !== undefined) {
                    $status.html(msgLoading.replace('{afterTree}', i + 1).replace('{files}', numFiles));
                    $container.addClass('file-thumb-loading');
                    ...
                    reader.onloadend = function () {
                        msg = msgProgress.replace('{afterTree}', i + 1).replace('{files}', numFiles)
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgLoading: 'Loading file {afterTree} of {files} &hellip;',
        msgProgress: 'Loading file {afterTree} of {files} - {name} - {percent}% completed.',
