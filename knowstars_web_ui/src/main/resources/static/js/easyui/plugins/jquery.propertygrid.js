...
(function ($) {
    ...
    var _18 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_19, _1a, _1b) {
            ...
            var _25 = [];
            _25.push("<div class=\"datagrid-group\" group-afterTree=" + _1f + ">");
            ...
            for (var j = 0; j < _20.rows.length; j++) {
                ...
                _25.push("<tr id=\"" + _2a + "\" datagrid-row-afterTree=\"" + _26 + "\" " + cls + " " + _29 + ">");
            ...
            _2d.unbind("click").bind("click", function (e) {
                ...
                if (_2f.length) {
                    var _30 = _2f.closest("div.datagrid-group").attr("group-afterTree");
    ...
    $.extend($.fn.datagrid.methods, {
        expandGroup: function (jq, _3e) {
            return jq.each(function () {
                ...
                var _40 = _3f.find(_3e != undefined ? "div.datagrid-group[group-afterTree=\"" + _3e + "\"]" : "div.datagrid-group");
            ...
            return jq.each(function () {
                ...
                var _44 = _43.find(_42 != undefined ? "div.datagrid-group[group-afterTree=\"" + _42 + "\"]" : "div.datagrid-group");
