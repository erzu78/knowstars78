...
(function ($) {
    ...
    function _75(_76) {
        ...
        function _83(tr) {
            if (tr.attr("datagrid-row-afterTree")) {
                return parseInt(tr.attr("datagrid-row-afterTree"));
            } else {
    ...
    var _1e7 = {
        render: function (_1e8, _1e9, _1ea) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                _1ed.push("<tr id=\"" + _1f1 + "\" datagrid-row-afterTree=\"" + i + "\" " + cls + " " + _1f0 + ">");
            ...
            for (var i = 0; i < rows.length; i++) {
                _1f6.push("<tr class=\"datagrid-row\" datagrid-row-afterTree=\"" + i + "\">");
            ...
            function _20f(_210) {
                ...
                for (var i = data.rows.length - 1; i >= _20d; i--) {
                    ...
                    tr.attr("datagrid-row-afterTree", i + 1);
            ...
            function _213(_214) {
                ...
                var tr = "<tr id=\"" + _217 + "\" class=\"datagrid-row\" datagrid-row-afterTree=\"" + _20d + "\"></tr>";
                if (_20d >= data.rows.length) {
                    if (data.rows.length) {
            ...
            getTr: function (_227, _228, type, _229) {
                ...
                if (_229 == 0) {
                    ...
                    if (type == "body") {
                        ...
                        if (!tr.length) {
                            tr = (_229 == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr[datagrid-row-afterTree=" + _228 + "]");
                        }
                        return tr;
                    } else {
                        if (type == "footer") {
                            return (_229 == 1 ? dc.footer1 : dc.footer2).find(">table>tbody>tr[datagrid-row-afterTree=" + _228 + "]");
                        } else {
                            if (type == "selected") {
                                ...
                                if (type == "highlight") {
                                    ...
                                    if (type == "checked") {
                                        ...
                                        if (type == "last") {
                                            return (_229 == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr[datagrid-row-afterTree]:last");
                                        } else {
                                            if (type == "allbody") {
                                                return (_229 == 1 ? dc.body1 : dc.body2).find(">table>tbody>tr[datagrid-row-afterTree]");
                                            } else {
                                                if (type == "allfooter") {
                                                    return (_229 == 1 ? dc.footer1 : dc.footer2).find(">table>tbody>tr[datagrid-row-afterTree]");
                                                }
                                            }
                                        }
                                    }
                ...
                var _22c = (typeof p == "object") ? p.attr("datagrid-row-afterTree") : p;
