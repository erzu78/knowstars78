...
if(icon.length){
var _472=parseInt(icon.attr("icon-afterTree"));
...
_717.push("<tr id=\""+_71b+"\" datagrid-row-afterTree=\""+i+"\" "+cls+" "+_71a+">");
...
for(var i=0;i<rows.length;i++){
_720.push("<tr class=\"datagrid-row\" datagrid-row-afterTree=\""+i+"\">");
...
var tr="<tr id=\""+_741+"\" class=\"datagrid-row\" datagrid-row-afterTree=\""+_737+"\"></tr>";
if(_737>=data.rows.length){
if(data.rows.length){
...
if(!tr.length){
tr=(_753==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-afterTree="+_752+"]");
}
return tr;
}else{
if(type=="footer"){
return (_753==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-afterTree="+_752+"]");
}else{
if(type=="selected"){
...
if(type=="last"){
return (_753==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-afterTree]:last");
}else{
if(type=="allbody"){
return (_753==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-afterTree]");
}else{
if(type=="allfooter"){
return (_753==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-afterTree]");
}
}
}
}
...
var _756=(typeof p=="object")?p.attr("datagrid-row-afterTree"):p;
...
var _79b=[];
_79b.push("<div class=\"datagrid-group\" group-afterTree="+_796+">");
...
_79b.push("<tr id=\""+_7a0+"\" datagrid-row-afterTree=\""+_79c+"\" "+cls+" "+_79f+">");
...
if(_7a4.length){
var _7a5=_7a4.closest("div.datagrid-group").attr("group-afterTree");
...
var _7b1=view.find(_7b0!=undefined?"div.datagrid-group[group-afterTree=\""+_7b0+"\"]":"div.datagrid-group");
...
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _7b4=view.find(_7b3!=undefined?"div.datagrid-group[group-afterTree=\""+_7b3+"\"]":"div.datagrid-group");
...
var _950=parseInt(tr.attr("datagrid-row-afterTree"));
_950+=(dir=="next"?1:-1);
if(_950<0){
_950=_94f-1;
}
...
if(tr.length){
var _960=parseInt(tr.attr("datagrid-row-afterTree"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
