...
public class OSSClientUtil implements Serializable {
    ...
    // 空间
    private String bucketName = "gaokangle";
    // 文件存储目录
    private String filedir = "gaoakngle/";
    ...
    public String getImgUrl(String fileUrl) {
        System.out.println(fileUrl+"22222222222222222");
    ...
    public String getUrl(String key) {
        ...
        if (url != null) {
            System.out.println(url+"3333333333333333333");
            return url.toString();
        }
        return "";
    }
